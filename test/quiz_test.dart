...
void main() {
  ...
  Player p1 = Player(name: 'zuko');
  Player p2 = Player(name: 'aang');
  Player p3 = Player(name: 'toph');

  Quiz quiz = Quiz(players: [p1, p2, p3], questions: [q1, q2]);

  test('All answers correct (100%) answered by zuko', () {
  ...
  test('One answer wrong (50%) answered by aang', () {
    Answer a1 = Answer(question: q1, answerChoice: 'Paris');
  ...
  test('All answers wrong (0%) answered by toph', () {
